                    ...
                    <table class="table table-bordered text-dark text-center">
                        ...
                        <tbody>
                            ...
                            <tr v-for="(item,index) in order_success.order_details" :key="item.id">
                                ...
                                <td>{{item.discount}} %</td>
                                <td class="text-right">{{  (item.quantity * item.price) - (item.quantity * item.price)*(item.discount / 100) - (item.quantity * item.price)*(order_success.discount / 100) | currency('đ', 0 , { thousandsSeparator: ',' , spaceBetweenAmountAndSymbol:true   ,symbolOnLeft: false}) }}</td>
                            </tr>
                            <tr>
